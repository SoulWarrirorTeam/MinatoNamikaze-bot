...
from MinatoNamikaze import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
...
from MinatoNamikaze import telethn as MinatoTelethonClient, TIGERS, DRAGONS, DEMONS
